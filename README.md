...
4. Send by pasting a BOLT11 invoice, reviewing the mint, amount and maximum fee before confirming, or choose Send ecash, enter an amount, and the token is created at once.
